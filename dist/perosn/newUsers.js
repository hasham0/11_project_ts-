...
async function newUser() {
    ...
    const u4 = new Users(newUserInfo["userName"], newUserInfo["userFathename"], newUserInfo["age"], newUserInfo["cnic"], newUserInfo["gender"], newUserInfo["Amount"], newUserInfo["password"]);
    //diaplay information
    console.log("------------------------------------");
